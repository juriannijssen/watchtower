/* Commitment data — generated from commitments/commitment-barclays-coal-mining-2030-eu-oecd.md
...
window.WATCHTOWER_CASE = {
  "schema_version": "3.11",
  "commitment": {
    "commitment_id": "barclays-coal-mining-2030-eu-oecd",
    "bank": "Barclays",
    ...
    "subject": "Coal Mining in the EU and OECD",
    "article_published": null,
    "intro": "Barclays sets out this phase-out in the Thermal Coal Mining section of its Climate Change Statement of December 2025. It commits the bank to end its financing of thermal coal mining companies in the EU and OECD by the start of 2030.",
    "naive_reading": "it is ending its financing of coal mining companies in Europe and the OECD",
    ...
    "sources": [
      {
        ...
        "synthesis_url": "https://watchtower.bank.green/institution/barclays/document/4122/synthesis?run=219&commitment=23",
    ...
    "clauses": [
      {
        ...
        "source_id": "ccs2025",
        "title": "The rule",
        "intro": "The first of the statement's dated phase-outs for thermal coal mining.",
        "location": {
          "distance": "same_passage",
          "signposting": "explicit",
          "signposting_note": null
        },
        "verbatim": "By 1 January 2030: For EU and OECD, we will phase out financing to all clients engaged in thermal coal mining.",
        ...
        "phrases": [
          {
            ...
            "means": "The words “For EU and OECD” limit the 2030 date to one group of countries. The statement does not say whether the client's location, its mines' location or its incorporation decides.",
            "lets_through": [
              "This wording lets through coal miners outside the EU and OECD until 2035, subject only to the 10% threshold from 2030."
            ],
          ...
          },
          {
            ...
            "means": "The words “phase out” describe a reduction to zero by the date, with no pace set before it.",
            "lets_through": [
              "This wording lets through financing at any level until 1 January 2030, subject to the other coal-mining rules."
            ],
            "defined_in_clause": null,
            "bank_definition": null
          }
        ...
        "phrases": [
          {
            ...
            "lets_through": [
              "This wording lets through clients at or below 5%, and low-coal entities of coal-heavy groups."
            ],
            "defined_in_clause": null,
            "bank_definition": null
          }
        ...
        "phrases": [
          {
            ...
            "lets_through": [
              "This wording lets through transition finance after 2030 to any coal client Barclays judges to be reducing its coal portfolio."
            ],
            "defined_in_clause": null,
            "bank_definition": null
          }
    ...
    "watchtower": {
      ...
      "commitment_index": 23,
      "commitment_id": "bbdfebd6-ffc4-53ea-8394-671c83eaafea",
      "url": "https://watchtower.bank.green/institution/barclays/document/4122/synthesis?run=219&commitment=23",
      ...
      "summary_text": "By 1 January 2030, Barclays will phase out financing to all clients engaged in thermal coal mining (>5% revenue) in the EU and OECD.",
      "scope": {
        "industry": {
          "themes": "coal",
          "coal_types": "thermal",
    ...
    "assessment": {
      ...
      "verdict_options": [
        {
          ...
          "recommended": true,
          "recommended_because": "A dated phase-out at 5% covering all financing is genuinely strong; conceding it first makes the limits land.",
          "text": "Credit first: by 2030, in the EU and OECD, every client earning more than 5% of its revenue from thermal coal mining loses all Barclays financing — not only project loans. That is a low threshold and a real date.\n\nThe limits are geography, measurement and exceptions. The statement does not say what places a client in the EU or OECD. The 5% is measured on the entity financed, not its group. And transition finance can be excepted case by case."
        },
        {
          "angle": "fails_to_block",
          "recommended": false,
          "recommended_because": null,
          "text": "The phase-out has a date, a threshold and three soft edges.\n\nWhat makes a client “EU and OECD” is not defined. The 5% applies to the entity being financed, so a group can borrow through a low-coal entity. And after 2030, transition finance to a coal client reducing its portfolio can be excepted case by case, with no disclosure.\n\nUntil 2030, the phase-out sets no pace."
        },
        {
          "angle": "who_it_catches",
          "recommended": false,
          "recommended_because": null,
          "text": "Ask who loses financing in 2030.\n\nEU and OECD clients above 5% of revenue from thermal coal mining, seeking financing that is not excepted as transition finance. Those are caught.\n\nThe same clients elsewhere wait until 2035. Low-coal entities of coal groups are not caught at all."
        }
      ],
      "verdict_selected": 0,
      "verdict_final": null,
      ...
      "what_needs_to_change": [
        {
          ...
          "content": "Say whether the client's incorporation, operations or mines decide whether it is an EU or OECD client."
        },
        {
      ...
      "what_needs_to_change_closing": "Until then, the 2030 date is firm and the edges of who it reaches are not.",
      "reviewed_by": null,
      "reviewed_at": null
    }
  },
  "evidence": {
    "status": "not_checked",
    "teaser": "Barclays commits to phase out financing to thermal coal mining clients in the EU and OECD by 2030. We have not yet reviewed what it financed against this commitment.",
    "headline_figure": {
      "display": null,
      "combines": null,
      "complete": false
