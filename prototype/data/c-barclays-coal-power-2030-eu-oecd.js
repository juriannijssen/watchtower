/* Commitment data — generated from commitments/commitment-barclays-coal-power-2030-eu-oecd.md
...
window.WATCHTOWER_CASE = {
  "schema_version": "3.11",
  "commitment": {
    "commitment_id": "barclays-coal-power-2030-eu-oecd",
    "bank": "Barclays",
    "commitment_number": 30,
    "category": "coal",
    "effective_date": "2030-01-01",
    "title": "Barclays' 2030 Coal Power Phase-out in the EU and OECD",
    "short_title": "2030 Coal Power Phase-out in the EU and OECD",
    "subject": "Coal Power in the EU and OECD",
    "article_published": null,
    "intro": "Barclays sets out this phase-out in the Thermal Coal Power section of its Climate Change Statement of December 2025. It commits the bank to end its financing of coal-fired power companies in the EU and OECD by the start of 2030.",
    "naive_reading": "it is ending its financing of coal power companies in Europe and the OECD",
    "plain_language_note": "The rule is plain; the conditions that suspend the date, the exception and the definition come from elsewhere in the section and the statement.",
    ...
    "sources": [
      {
        ...
        "synthesis_url": "https://watchtower.bank.green/institution/barclays/document/4122/synthesis?run=219&commitment=30",
    ...
    "clauses": [
      {
        ...
        "source_id": "ccs2025",
        "title": "The rule",
        "intro": "The first of the statement's dated phase-outs for coal-fired power.",
        "location": {
          "distance": "same_passage",
          "signposting": "explicit",
          "signposting_note": null
        },
        "verbatim": "By 1 January 2030: For EU and OECD, we will phase out financing to clients engaged in thermal coal-fired power generation.",
        ...
        "phrases": [
          {
            ...
            "means": "The words “For EU and OECD” limit the 2030 date to one group of countries, without saying what places a client there.",
            "lets_through": [
              "This wording lets through coal power clients elsewhere until 2035, subject to the 10% threshold from 2030."
            ],
          ...
          },
          {
            ...
            "lets_through": [
              "This wording lets through financing at any level before 2030, subject to the 30% rule."
            ],
            "defined_in_clause": null,
            "bank_definition": null
          }
      ...
      },
      {
        ...
        "intro": "Later in the same section, three conditions under which the phase-out dates do not apply.",
        "location": {
          "distance": "nearby",
          "signposting": "none",
          "signposting_note": "The dated rule reads as complete; the conditions that suspend it follow after the 2035 date, and nothing in the rule points to them."
        },
        ...
        "phrases": [
          ...
          },
          {
            ...
            "lets_through": [
              "This wording lets through clients whose coal plants are held open by a contract — including a power-purchase agreement the client itself signed."
            ],
            "defined_in_clause": null,
            "bank_definition": null
          }
        ...
        "phrases": [
          {
            ...
            "lets_through": [
              "This wording lets through transition finance after 2030 to coal power clients Barclays judges to be reducing their coal portfolio."
            ],
            "defined_in_clause": null,
            "bank_definition": null
          }
    ...
    "watchtower": {
      ...
      "commitment_index": 30,
      "commitment_id": "5fe029c7-0cb0-54b6-9715-5e6449f6abbc",
      "url": "https://watchtower.bank.green/institution/barclays/document/4122/synthesis?run=219&commitment=30",
      ...
      "summary_text": "By 1 January 2030, Barclays will phase out financing for clients engaged in thermal coal-fired power generation (>5% revenue) in the EU and OECD.",
      "scope": {
        "industry": {
          "themes": "coal",
          "coal_types": "thermal",
    ...
    "assessment": {
      ...
      "verdict_options": [
        {
          ...
          "recommended": true,
          "recommended_because": "Three conditions suspend the date, one of them open to the client's own contracts; stated flatly that is the gap.",
          "text": "The date is 2030, and three conditions suspend it.\n\nPlants abated to near zero — undefined. Plants kept only as backup to low-carbon supply. Plants required to stay open by law, regulation or contract — and a contract can be one the client signed. A client whose remaining coal plants fall under any of these keeps its financing past 2030.\n\nOn top, transition finance can be excepted case by case, and the 5% is measured on the entity financed."
        },
        {
          "angle": "who_it_catches",
          "recommended": false,
          "recommended_because": null,
          "text": "Ask who loses financing in 2030.\n\nAn EU or OECD client above 5% of revenue from coal power whose plants are not abated, not backup, and not held open by law or contract, and which is not receiving transition finance. That client is caught."
        },
        {
          "angle": "what_it_gets_right",
          "recommended": false,
          "recommended_because": null,
          "text": "Credit first: a 2030 phase-out at 5% covering all financing is a real date and a low threshold.\n\nWhere it stops is the three conditions that suspend it, which the statement lists without defining."
        }
      ],
      "verdict_selected": 0,
      "verdict_final": null,
      ...
      "what_needs_to_change": [
        ...
        },
        {
          ...
          "content": "Say what places a client in the EU or OECD."
        }
      ],
      "what_needs_to_change_closing": "Until then, the 2030 date applies to plants that are not abated, backup or contracted.",
      "reviewed_by": null,
      "reviewed_at": null
    }
  },
  "evidence": {
    "status": "not_checked",
    "teaser": "Barclays commits to phase out financing to coal-fired power clients in the EU and OECD by 2030. We have not yet reviewed what it financed against this commitment.",
    "headline_figure": {
      "display": null,
      "combines": null,
      "complete": false
