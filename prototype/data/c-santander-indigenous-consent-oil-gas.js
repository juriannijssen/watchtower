/* Commitment data — generated from commitments/commitment-santander-indigenous-consent-oil-gas.md
...
window.WATCHTOWER_CASE = {
  "schema_version": "3.11",
  "commitment": {
    "commitment_id": "santander-indigenous-consent-oil-gas",
    "bank": "Santander",
    "commitment_number": 3,
    "category": "other",
    ...
    "naive_reading": "it will not finance oil and gas projects that go ahead without Indigenous Peoples' consent",
    ...
    "sources": [
      {
        ...
        "synthesis_url": "https://watchtower.bank.green/institution/santander/document/25536/synthesis?run=149&commitment=3",
    ...
    "clauses": [
      {
        ...
        "source_id": "esg",
        "title": "The rule",
        "intro": "The item in the policy's list of restrictions, under the lead-in that governs all of them. It applies to projects in every sector the policy covers.",
        "location": {
        ...
        "phrases": [
          {
            ...
            "lets_through": [
              "This wording lets through projects that affect Indigenous Peoples in ways the standard handles through consultation rather than consent. They are outside this commitment whether or not the communities agree."
            ],
          ...
          },
          {
            ...
            "lets_through": [
              "This wording lets through a project that has not obtained consent, if it has a plan the bank finds credible. The financing goes ahead on the plan, before the consent it is meant to secure."
            ],
            "defined_in_clause": null,
            "bank_definition": null
          }
    ...
    "watchtower": {
      ...
      "commitment_index": 3,
      "commitment_id": null,
      "url": "https://watchtower.bank.green/institution/santander/document/25536/synthesis?run=149&commitment=3",
      ...
      "summary_text": "Santander restricts project financing for oil and gas projects requiring FPIC that fail to meet IFC Performance Standard 7, unless a credible compliance action plan is in place.",
      "scope": {
        "industry": {
          "themes": "oil_gas",
          "coal_types": null,
