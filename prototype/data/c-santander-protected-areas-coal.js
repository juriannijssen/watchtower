/* Commitment data — generated from commitments/commitment-santander-protected-areas-coal.md
...
window.WATCHTOWER_CASE = {
  "schema_version": "3.11",
  "commitment": {
    "commitment_id": "santander-protected-areas-coal",
    "bank": "Santander",
    "commitment_number": 2,
    "category": "coal",
    "effective_date": null,
    ...
    "intro": "Santander sets out this restriction in its Environmental and Social Risk Management Policy; the version on file is the revision approved in June 2025. It commits the bank not to invest in, or provide financial products and services to, mining and power projects that threaten wetlands of international importance, World Heritage Sites or protected nature areas.",
    "naive_reading": "it will not finance coal mines or power plants that threaten protected nature areas",
    ...
    "sources": [
      {
        ...
        "synthesis_url": "https://watchtower.bank.green/institution/santander/document/25536/synthesis?run=149&commitment=2",
    ...
    "clauses": [
      {
        ...
        "phrases": [
          ...
          },
          {
            ...
            "means": "This explains which areas count and when. Beside Ramsar and World Heritage Sites, only IUCN protected areas in categories I to IV are named, and the restriction applies when a mine or plant puts one “at risk” — a test the policy does not define, and does not say who applies.",
            "lets_through": [
              "This wording lets through coal mines and power plants in IUCN categories V and VI — protected landscapes and areas managed for sustainable use — and in protected areas that carry no IUCN category at all.",
              "It also lets through any mine or plant Santander's own assessment finds does not put the area at risk, including one beside it or upstream of it. The policy gives no distance, buffer or method."
            ],
            "defined_in_clause": null,
            "bank_definition": null
          }
    ...
    "watchtower": {
      ...
      "commitment_index": 2,
      "commitment_id": null,
      "url": "https://watchtower.bank.green/institution/santander/document/25536/synthesis?run=149&commitment=2",
      ...
      "summary_text": "Santander restricts project-related financing for coal mining or power projects that put Ramsar, World Heritage, or IUCN Category I-IV sites at risk, subject to high-level governance exceptions.",
      "scope": {
        "industry": {
          "themes": "coal",
          "coal_types": null,
    ...
    "assessment": {
      ...
      "verdict_options": [
        {
          ...
          "recommended": true,
          "recommended_because": "The places named are the right ones; the gap is in which categories count and in an undefined test of harm.",
          "text": "The list of places is familiar, and the protection is narrower than it looks.\n\nWetlands of international importance and World Heritage Sites are named in full. Other protected areas count only if the IUCN classifies them in categories I to IV, which leaves out categories V and VI — protected landscapes and areas managed for sustainable use — and national reserves with no IUCN category at all.\n\nThe trigger is soft. A mine or a power plant is caught when it puts one of these areas “at risk”, and the policy does not say how risk is judged, at what distance, or by whom. An open-pit mine at the edge of a reserve, or the rail line and port that serve it, can be assessed as not putting it at risk.\n\nAnd the whole section sits under the policy's standing exception: corporate governance bodies can approve exceptions aligned with its principles. The commitment names the right places, and leaves the question of harm to Santander."
        },
        {
          "angle": "who_it_catches",
          "recommended": false,
          "recommended_because": null,
          "text": "Ask which coal projects this commitment actually stops.\n\nA mine or power plant inside a Ramsar wetland, a World Heritage Site or an IUCN category I–IV area, which Santander itself judges to put that area at risk, and for which no exception is approved. That project is caught.\n\nOne in a category V or VI area is not. Neither is one in a protected area with no IUCN category, nor one beside a protected area that Santander's assessment finds does not put it at risk, nor one approved as an exception by the policy's governance bodies.\n\nThe commitment binds the unambiguous case. Everything that turns on judgement — category, distance, risk — is decided inside the bank."
        },
        {
      ...
      "what_needs_to_change_closing": "Until then, the commitment protects the places everyone agrees on, as far as Santander decides a mine or plant threatens them.",
      "reviewed_by": null,
      "reviewed_at": null
    }
  },
  "evidence": {
    "status": "not_checked",
    "teaser": "Santander commits not to finance mining and power projects that put protected areas at risk. We have not yet reviewed what it financed against this commitment.",
    "headline_figure": {
      "display": null,
      "combines": null,
      "complete": false
