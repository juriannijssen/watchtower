/* Commitment data — generated from commitments/commitment-santander-coal-power-infrastructure.md
...
window.WATCHTOWER_CASE = {
  "schema_version": "3.11",
  "commitment": {
    "commitment_id": "santander-coal-power-infrastructure",
    "bank": "Santander",
    ...
    "intro": "Santander sets out this restriction in the power generation section of its Environmental and Social Risk Management Policy; the version on file is the revision approved in June 2025. It commits the bank not to finance infrastructure built to serve coal-fired power generation.",
    "naive_reading": "it will not finance infrastructure built to serve coal power",
    ...
    "sources": [
      {
        ...
        "synthesis_url": "https://watchtower.bank.green/institution/santander/document/25536/synthesis?run=149&commitment=12",
    ...
    "clauses": [
      {
        ...
        "verbatim": "Santander Group will not directly invest in and/or provide financial products and/or services to the following activities in any client segment: … Project-related financing for the construction or development of infrastructure projects whose expected revenues from coal power generation-related activities will be more than 30% of the project’s revenues in the first five years.",
        ...
        "phrases": [
          ...
          },
          {
            ...
            "lets_through": [
              "This wording lets through any project whose forecast puts coal below the line, whatever it earns once built."
            ],
            "defined_in_clause": null,
            "bank_definition": null
          },
          {
            ...
            "means": "This explains the threshold: coal power-related revenue as a share of the project's revenue.",
            "lets_through": [
              "This wording lets through infrastructure that earns up to 30% of its revenue from coal power — a line, port or rail link that serves coal plants alongside other users."
            ],
            "defined_in_clause": null,
            "bank_definition": null
          },
          {
            ...
            "lets_through": [
              "This wording lets through infrastructure whose coal share rises after year five. A project built for mixed use and later dominated by coal passes the test at the start."
            ],
            "defined_in_clause": null,
            "bank_definition": null
          }
    ...
    "watchtower": {
      ...
      "commitment_index": 12,
      "commitment_id": null,
      "url": "https://watchtower.bank.green/institution/santander/document/25536/synthesis?run=149&commitment=12",
      ...
      "summary_text": "Santander restricts project-related financing for the construction or development of infrastructure projects where expected revenues from coal power generation exceed 30% in the first five years.",
      "scope": {
        "industry": {
          "themes": "coal",
          "coal_types": "thermal",
      ...
      "triggers": [
        {
          ...
          "inequality": ">",
          "value": 30,
          "definition": "expected revenues from coal power generation-related activities of the project's revenues in the first five years",
      ...
      "verdict_options": [
        {
          ...
          "text": "The test is passed at the forecast stage, and never taken again.\n\nA project is caught if its expected revenues from coal power-related activities will be more than 30% of its revenues in its first five years. Each part narrows it. “Expected” makes it a forecast, and the policy does not say whose. “More than 30%” lets through infrastructure that serves coal alongside other users. “The first five years” lets through a project whose coal share rises later.\n\nAnd the restriction reaches project-related financing only, so the infrastructure's owner can still borrow at company level.\n\nWhat remains is a project loan for infrastructure forecast, at the outset, to depend mostly on coal power."
        },
        {
          "angle": "who_it_catches",
          "recommended": false,
          "recommended_because": null,
          "text": "Ask who has to change anything because of this commitment.\n\nA developer seeking project financing from Santander for infrastructure whose own forecast shows more than 30% of its first five years' revenue coming from coal power. That developer is caught.\n\nA developer whose forecast shows less is not, whatever happens afterwards. An owner financing the same infrastructure at company level is not.\n\nThe commitment binds the dedicated coal project that says so in its own numbers, and releases everything that can be described as mixed use."
        },
        {
          "angle": "what_it_gets_right",
          "recommended": false,
          "recommended_because": null,
          "text": "Credit first: the restriction reaches past the plant to the infrastructure that serves it, and it publishes the test — a share, a threshold and a period — rather than leaving “primarily” or “dedicated” undefined.\n\nWhere it stops is the kind of number it uses. A forecast, not an outcome; a share, not an amount; the first five years, not the asset's life. Each makes the test easier to pass on paper than in operation.\n\nA published test for coal infrastructure is worth having. This one measures the plan, not the asset."
        }
      ],
      "verdict_selected": 0,
      "verdict_final": null,
  ...
  "evidence": {
    "status": "not_checked",
    "teaser": "Santander commits not to finance infrastructure projects that would depend on coal power for more than 30% of their revenue. We have not yet reviewed what it financed against this commitment.",
    "headline_figure": {
      "display": null,
      "combines": null,
      "complete": false
